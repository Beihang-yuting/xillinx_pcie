//=============================================================================
// Xilinx PCIe TL-Layer BFM - VCS 编译文件列表 (all-EP 冒烟)
// 使用方法：vcs -f filelist_allep.f <其他选项>
// 与 filelist_multi.f 一致，仅将 TB 顶层换为 tb_allep_smoke.sv 并加入 all-EP 测试。
//=============================================================================
...
// 测试平台文件（TB modules）
// all-EP 冒烟顶层（0 RC + 2 EP，无 DUT）
/home/ubuntu/ryan/xilinx_pcie/tb/tb_allep_smoke.sv
...
/home/ubuntu/ryan/xilinx_pcie/tests/xilinx_pcie_allep_test.sv
