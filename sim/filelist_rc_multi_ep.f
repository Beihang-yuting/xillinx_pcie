//=============================================================================
// Xilinx PCIe TL-Layer BFM - VCS 编译文件列表（1 RC + 多 EP 回归）
// 使用方法：vcs -f filelist_rc_multi_ep.f <其他选项>
//
// 本 filelist 服务两个回归测试，均跑在 tb_rc_multi_ep（1 RC + 4 EP）上：
//   +UVM_TESTNAME=xilinx_pcie_multi_ep_test     （num_rc=0, num_ep=4）
//   +UVM_TESTNAME=xilinx_pcie_rc_multi_ep_test  （num_rc=1, num_ep=4）
//=============================================================================
...
// 测试平台文件（TB modules）
// 1 RC + 4 EP 多 agent 顶层（无 DUT；不含 loopback_dut，否则其接口端口悬空报错）
/home/ubuntu/ryan/xilinx_pcie/tb/tb_rc_multi_ep.sv

// 测试用例文件（各 test class）
/home/ubuntu/ryan/xilinx_pcie/tests/xilinx_pcie_base_test.sv
/home/ubuntu/ryan/xilinx_pcie/tests/xilinx_pcie_multi_ep_test.sv
/home/ubuntu/ryan/xilinx_pcie/tests/xilinx_pcie_rc_multi_ep_test.sv
